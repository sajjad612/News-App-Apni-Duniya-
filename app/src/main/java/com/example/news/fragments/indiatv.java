...
public class indiatv extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_indiatv, container, false);

        WebView webview = view.findViewById(R.id.webviewIndiatv);
        webview.loadUrl("https://www.indiatv.in/");
